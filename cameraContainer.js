class CameraItem extends Phaser.GameObjects.Container {
...
class CameraContainer extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        var themeTitle = scene.add.text(w/2, 45, 'Камеры', {fontFamily: 'Arial', fontSize: 40, color: '#000'});
        ...
        var item1 = new CameraItem(scene, 0, 0, 'Камера 1', 60, 'в месяц', function () {
            console.log('item');
        });

        var item2 = new CameraItem(scene, 0, 0, 'Камера 2', 80, 'в месяц', function () {
            console.log('item');
        });

        var item3 = new CameraItem(scene, 0, 0, 'Камера 3', 160, 'в месяц', function () {
            console.log('item');
        });

        var item4 = new CameraItem(scene, 0, 0, 'Камера 4', 280, 'в месяц', function () {
            console.log('item');
        });

        var item5 = new CameraItem(scene, 0, 0, 'Камера 5', 560, 'в месяц', function () {
            console.log('item');
        });
