class StudioItem extends Phaser.GameObjects.Container {
...
class StudioContainer extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        var themeTitle = scene.add.text(w/2, 45, 'Студии', {fontFamily: 'Arial', fontSize: 40, color: '#000'});
        ...
        var item1 = new StudioItem(scene, 0, 0, 'Studio 1', 60, 'в месяц', function () {
            console.log('item');
        });

        var item2 = new StudioItem(scene, 0, 0, 'Studio 2', 80, 'в месяц', function () {
            console.log('item');
        });

        var item3 = new StudioItem(scene, 0, 0, 'Studio 3', 160, 'в месяц', function () {
            console.log('item');
        });

        var item4 = new StudioItem(scene, 0, 0, 'Studio 4', 280, 'в месяц', function () {
            console.log('item');
        });

        var item5 = new StudioItem(scene, 0, 0, 'Studio 5', 560, 'в месяц', function () {
            console.log('item');
        });
