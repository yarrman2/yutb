class PropItem extends Phaser.GameObjects.Container {
...
class PropContainer extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        var themeTitle = scene.add.text(w/2, 45, 'Реквизит', {fontFamily: 'Arial', fontSize: 40, color: '#000'});
        ...
        var item1 = new PropItem(scene, 0, 0, 'Реквизит 1', 60, 'в месяц', function () {
            console.log('item');
        });

        var item2 = new PropItem(scene, 0, 0, 'Реквизит 2', 80, 'в месяц', function () {
            console.log('item');
        });

        var item3 = new PropItem(scene, 0, 0, 'Реквизит 3', 160, 'в месяц', function () {
            console.log('item');
        });

        var item4 = new PropItem(scene, 0, 0, 'Реквизит 4', 280, 'в месяц', function () {
            console.log('item');
        });

        var item5 = new PropItem(scene, 0, 0, 'Реквизит 5', 560, 'в месяц', function () {
            console.log('item');
        });
