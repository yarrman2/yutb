class ThemeItem extends Phaser.GameObjects.Container {
...
class ThemeContainer extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        var themeTitle = scene.add.text(w/2, 45, 'Тема', {fontFamily: 'Arial', fontSize: 40, color: '#000'});
